...
- [ ] Point-by-point log
- [ ] Dark/light theme
- [ ] Sound effects on point/game/set/match
- [ ] Vibration feedback on remote control
- [ ] Player stats & win/loss records

## Future Ideas (v3+)
- [ ] Americano tournament mode
- [ ] Share match results (image/link)
- [ ] Spectator view (read-only scoreboard link)
- [ ] Apple Watch optimized remote
